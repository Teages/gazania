import type { RequireOperationPartialData, TypedPartialPackage } from '../../src/runtime/builder-types'
import type { ResultOf } from '../../src/runtime/document'
import type { FragmentOf, FragmentRef } from '../../src/runtime/masking'
import type { AnalyzedObjectSelection, ParseObjectSelection, ParseObjectSelectionContext } from '../../src/runtime/result'
