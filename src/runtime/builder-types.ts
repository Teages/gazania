...
import type { RootDollar, TypedSelectionSet } from './dollar-types'
...
import type { AnyVariables, PrepareVariables, RequireVariables, VariablesDefinition } from './variable-types'
